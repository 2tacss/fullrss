...
<html>
  ...
  <body>
	...
	<div class="container" style="width: 800px; padding-bottom: 60px;">
		<div class="note">
			遷移先のページにいくつか変更を加えました．<br />
			PCで見る前提ですが，モニタは画面が大きいので<br />
			少しだけ見やすくしました．<br />
			見づらい場合はもとに戻すので気軽におっしゃってください．<br />
			<ul class="ullist">
				<li>ページの幅を60％に縮小(スマホは100％で表示されます)</li>
				<li>コンテンツを画面に対して中央寄せ</li>
				<li>記事にナンバリング</li>
				<li>記事の背景をグレーに変更</li>
				<li>記事の左サイドに青いマーカー</li>
				<li>フォントサイズを20％だけアップ</li>
				<li>フォントを丸みのあるものに変更</li>
			</ul>
			<br />
			もう少しいじると，
			<ul class="ullist">
